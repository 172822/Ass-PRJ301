        ...
        <div class="main">
            ...
            <div class="content">
                ...
                <div class="filter" style="margin-bottom: 16px;">
                    <form method="get" action="${pageContext.request.contextPath}/invoice">
                ...
                <c:if test="${sessionScope.user.role != 'STUDENT'}">
                    <p><a href="${pageContext.request.contextPath}/invoice?action=add<c:if test="${filterBoardingHouseId != null}">&boardingHouseId=${filterBoardingHouseId}</c:if>" class="btn btn-primary">Thêm hóa đơn</a></p>
                </c:if>
                <div class="card">
                    <table>
